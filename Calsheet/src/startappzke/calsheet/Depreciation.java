		...
		Calculate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if ((input1.getText().length() == 0)
					...
					double result2 =  Math.pow((1-result1),t);
					...
					* new Double(result2);
					...
					solution.setText("Depreciation "+ Double.toString(-r));
					solution1.setText("Last Amount "+Double.toString(result));
